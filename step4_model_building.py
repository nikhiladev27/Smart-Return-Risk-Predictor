...
# ---------------------------------------------------------
# 1️⃣ Load the engineered dataset
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# 3️⃣ ✅ CREATE PROPER 3-LEVEL RISK LABEL (FIXED)
# ---------------------------------------------------------
# ---------------------------------------------------------
# 3️⃣ Create ReturnRisk label (SAFE VERSION)
# ---------------------------------------------------------
...
if df["ReturnRisk"].nunique() == 1:
    print("⚠️ Only one class found! Forcing synthetic balance...")
...
# ---------------------------------------------------------
# 5️⃣ Handle categorical variables
# ---------------------------------------------------------
